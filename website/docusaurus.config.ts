...
const config: Config = {
  ...
  themeConfig: {
    ...
    footer: {
        ...
        },
        {
          ...
          items: [
            ...
            // },
            {
              ...
              href: 'https://github.com/geodaai/openassistant',
            },
            {
              label: 'GeoDaLib GitHub',
              href: 'https://github.com/geodaai/geodalib',
            },
            {
      ...
      copyright:
        '<div class="footer-custom"><div class="footer-logos" style="padding-bottom: 20px"><div class="footer-logos-left"><img class="light-only" style="padding-right: 20px;" height="40" src="img/geoda_color_black.png"/></div><div class="footer-logos-right"><img class="dark-only" style="padding-right: 20px;" height="40" src="img/geoda_color_white.png"/><img style="padding-right: 20px;" height="40" src="https://github.com/openjs-foundation/artwork/raw/main/openjs_foundation/openjs_foundation-logo-horizontal-color.png"/></div></div><div class="footer-copy">Copyright <a href="https://openjsf.org">OpenJS Foundation</a> and <a href="https://github.com/geodaai/openassistant">OpenAssistant</a> and <a href="https://github.com/geodaai/geodalib">GeoDaLib</a> contributors. All rights reserved. The <a href="https://openjsf.org">OpenJS Foundation</a> has registered trademarks and uses trademarks. For a list of trademarks of the <a href="https://openjsf.org">OpenJS Foundation</a>, please see our <a href="https://trademark-policy.openjsf.org/">Trademark Policy</a> and <a href="https://trademark-list.openjsf.org/">Trademark List</a>. Trademarks and logos not indicated on the <a href="https://trademark-list.openjsf.org">list of OpenJS Foundation trademarks</a> are trademarks™ or registered® trademarks of their respective holders. Use of them does not imply any affiliation with or endorsement by them.<br/><br/><a href="https://openjsf.org/">The OpenJS Foundation</a> | <a href="https://terms-of-use.openjsf.org/">Terms of Use</a> | <a href="https://privacy-policy.openjsf.org/">Privacy Policy</a> | <a href="https://bylaws.openjsf.org/">Bylaws</a> | <a href="https://code-of-conduct.openjsf.org">Code of Conduct</a> | <a href="https://trademark-policy.openjsf.org/">Trademark Policy</a> | <a href="https://trademark-list.openjsf.org/">Trademark List</a> | <a href="https://www.linuxfoundation.org/cookies/">Cookie Policy</a></div></div>',
    },
    prism: {
